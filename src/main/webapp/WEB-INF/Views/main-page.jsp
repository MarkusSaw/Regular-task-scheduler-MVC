...
<html>
<head>
    <title>Список дел для Markus Saw</title>
    ...
    <div class="container">
        ...
        <div class="records-container">
            <c:choose>
                        ...
                        <div class="record">
                            ...
                            <div class="record__controls">
                                <c:if test="${record.status == 'ACTIVE'}">
                                    <form action="/made-it-record" method="post" class="record__controls-form">
                                ...
                                <form action="/delete-excess-record" method="post" class="record__controls-form">
                                    <input type="hidden" name="id" value="${record.id}">
                                    <input type="hidden" name="filter" value="${fn:toLowerCase(param.filter)}">
                ...
                <div class="hint">
                    ...
                    <c:otherwise>
                <div class="hint">
                    <span>There are no tasks at all , try made new note!</span>
                </div>
                    </c:otherwise>
                    </c:choose>
                </c:otherwise>
        ...
        <div class="management-container">
            <form action="/add-record" method="post" class="management-form">
                <input type="text" name="title" placeholder="Please make a new  note..." class="management-form__input">
